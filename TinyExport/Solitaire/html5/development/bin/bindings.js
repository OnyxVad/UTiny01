...
entities.game.Board = entities.game.Board || {};
entities.game.Board.Component = function() {
};
entities.game.Board.Component.prototype = Object.create(null);
entities.game.Board.Component.prototype.constructor = entities.game.Board.Component;
Object.defineProperties(entities.game.Board.Component.prototype, {
});
entities.game.Board.Component._size = 1;
entities.game.Board.Component._fromPtr = function(ptr, v) {
  v = v || Object.create(entities.game.Board.Component.prototype);
  return v;
};
entities.game.Board.Component._toPtr = function(ptr, v) {
};
entities.game.Board.Component._toTempHeapPtr = function(ptr, v) {
};
entities.game.Board.Component._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) entities.game.Board.Component._toTempHeapPtr(ptr, v);
  return ptr;
};
entities.game.Board.Component.StorageView = function(ptr) {
  this._ptr = ptr;
};
entities.game.Board.Component.StorageView.prototype = Object.create(null);
entities.game.Board.Component.StorageView.prototype.constructor = entities.game.Board.Component.StorageView;
entities.game.Board.Component._view = entities.game.Board.Component.StorageView;
entities.game.Board.Component.StorageView._isSharedComp = entities.game.Board.Component._isSharedComp = false;
entities.game.Board.Component.StorageView._fromPtr = entities.game.Board.Component._fromPtr;
entities.game.Board.Component.StorageView._toPtr = entities.game.Board.Component._toPtr;
entities.game.Board.Component.StorageView._tempHeapPtr = entities.game.Board.Component._tempHeapPtr;
entities.game.Board.Component.StorageView._size = entities.game.Board.Component._size;
entities.game.Board.Component.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(entities.game.Board.Component.StorageView.prototype, {
});
entities.game.Board.Component._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// entities.game.Board.Component is a POD type, so a JavaScript side copy constructor entities.game.Board.Component._copyFn = function copy(src, dst) { ... } does not need to be generated for it
entities.game.Board.Component._typeDesc = (function() {
  return ut.meta.allocType(5, 'entities.game.Board.Component', 1, []);
})();
Object.defineProperties(entities.game.Board.Component, { cid: { configurable: true, get: function() { delete entities.game.Board.Component.cid; var offsetsPtr = 0, offsetsCount = 0; return entities.game.Board.Component.cid = Module._ut_component_register_cid_with_type(entities.game.Board.Component._typeDesc, 0, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(entities.game.Board.Component.StorageView, { cid: { configurable: true, get: function() { return entities.game.Board.Component.cid; } } });
entities.game.Card = entities.game.Card || {};
entities.game.Card.Component = function() {
};
entities.game.Card.Component.prototype = Object.create(null);
entities.game.Card.Component.prototype.constructor = entities.game.Card.Component;
Object.defineProperties(entities.game.Card.Component.prototype, {
});
entities.game.Card.Component._size = 1;
entities.game.Card.Component._fromPtr = function(ptr, v) {
  v = v || Object.create(entities.game.Card.Component.prototype);
  return v;
};
entities.game.Card.Component._toPtr = function(ptr, v) {
};
entities.game.Card.Component._toTempHeapPtr = function(ptr, v) {
};
entities.game.Card.Component._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) entities.game.Card.Component._toTempHeapPtr(ptr, v);
  return ptr;
};
entities.game.Card.Component.StorageView = function(ptr) {
  this._ptr = ptr;
};
entities.game.Card.Component.StorageView.prototype = Object.create(null);
entities.game.Card.Component.StorageView.prototype.constructor = entities.game.Card.Component.StorageView;
entities.game.Card.Component._view = entities.game.Card.Component.StorageView;
entities.game.Card.Component.StorageView._isSharedComp = entities.game.Card.Component._isSharedComp = false;
entities.game.Card.Component.StorageView._fromPtr = entities.game.Card.Component._fromPtr;
entities.game.Card.Component.StorageView._toPtr = entities.game.Card.Component._toPtr;
entities.game.Card.Component.StorageView._tempHeapPtr = entities.game.Card.Component._tempHeapPtr;
entities.game.Card.Component.StorageView._size = entities.game.Card.Component._size;
entities.game.Card.Component.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(entities.game.Card.Component.StorageView.prototype, {
});
entities.game.Card.Component._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// entities.game.Card.Component is a POD type, so a JavaScript side copy constructor entities.game.Card.Component._copyFn = function copy(src, dst) { ... } does not need to be generated for it
entities.game.Card.Component._typeDesc = (function() {
  return ut.meta.allocType(5, 'entities.game.Card.Component', 1, []);
})();
Object.defineProperties(entities.game.Card.Component, { cid: { configurable: true, get: function() { delete entities.game.Card.Component.cid; var offsetsPtr = 0, offsetsCount = 0; return entities.game.Card.Component.cid = Module._ut_component_register_cid_with_type(entities.game.Card.Component._typeDesc, 0, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(entities.game.Card.Component.StorageView, { cid: { configurable: true, get: function() { return entities.game.Card.Component.cid; } } });
var game = game || {};
game.Draggable = function(arg0) {
  this._IsLocked = (arg0 ? true : false);
};
game.Draggable.prototype = Object.create(null);
game.Draggable.prototype.constructor = game.Draggable;
Object.defineProperties(game.Draggable.prototype, {
  IsLocked: {
    get: function() { return this._IsLocked; },
    set: function(v) { this._IsLocked = (v ? true : false); },
  },
});
game.Draggable._size = 1;
game.Draggable._fromPtr = function(ptr, v) {
  v = v || Object.create(game.Draggable.prototype);
  v._IsLocked = (HEAP8[ptr+0]?true:false);
  return v;
};
game.Draggable._toPtr = function(ptr, v) {
  HEAP8[ptr+0] = (v.IsLocked)?1:0;
};
game.Draggable._toTempHeapPtr = function(ptr, v) {
  HEAP8[ptr+0] = (v.IsLocked)?1:0;
};
game.Draggable._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) game.Draggable._toTempHeapPtr(ptr, v);
  return ptr;
};
game.Draggable.StorageView = function(ptr) {
  this._ptr = ptr;
};
game.Draggable.StorageView.prototype = Object.create(null);
game.Draggable.StorageView.prototype.constructor = game.Draggable.StorageView;
game.Draggable._view = game.Draggable.StorageView;
game.Draggable.StorageView._isSharedComp = game.Draggable._isSharedComp = false;
game.Draggable.StorageView._fromPtr = game.Draggable._fromPtr;
game.Draggable.StorageView._toPtr = game.Draggable._toPtr;
game.Draggable.StorageView._tempHeapPtr = game.Draggable._tempHeapPtr;
game.Draggable.StorageView._size = game.Draggable._size;
game.Draggable.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(game.Draggable.StorageView.prototype, {
  IsLocked: {
    get: function() { return (HEAP8[this._ptr+0]?true:false); },
    set: function(v) { HEAP8[this._ptr+0] = (v)?1:0; },
  },
});
game.Draggable._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// game.Draggable is a POD type, so a JavaScript side copy constructor game.Draggable._copyFn = function copy(src, dst) { ... } does not need to be generated for it
game.Draggable._typeDesc = (function() {
  return ut.meta.allocType(5, 'game.Draggable', 1, [
    {name: 'IsLocked', offset: 0, type: ut.meta.getType('bool')}
  ]);
})();
Object.defineProperties(game.Draggable, { cid: { configurable: true, get: function() { delete game.Draggable.cid; var offsetsPtr = 0, offsetsCount = 0; return game.Draggable.cid = Module._ut_component_register_cid_with_type(game.Draggable._typeDesc, 1, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(game.Draggable.StorageView, { cid: { configurable: true, get: function() { return game.Draggable.cid; } } });
game.Draggable.IsLocked = { $ofs:0, $t:"bool", $c:game.Draggable };
var ut = ut || {};
ut.Core2D = ut.Core2D || {};
...
game.BoardSystemJS = ut.System.define({
  name: "game.BoardSystemJS"
});
game.DragCardSystemJS = ut.System.define({
  name: "game.DragCardSystemJS"
});
