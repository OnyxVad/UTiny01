...
(function (game) {
    /** New System */
    var BoardSystem = /** @class */ (function (_super) {
        __extends(BoardSystem, _super);
        function BoardSystem() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        BoardSystem.prototype.OnUpdate = function () {
        };
        return BoardSystem;
    }(ut.ComponentSystem));
    game.BoardSystem = BoardSystem;
})(game || (game = {}));
var game;
(function (game) {
    /** New System */
    var DragCardSystem = /** @class */ (function (_super) {
        __extends(DragCardSystem, _super);
        function DragCardSystem() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        DragCardSystem.prototype.OnUpdate = function () {
            this.world.forEach([game.Draggable], function (draggable) {
                console.log(draggable.IsLocked);
            });
        };
        return DragCardSystem;
    }(ut.ComponentSystem));
    game.DragCardSystem = DragCardSystem;
})(game || (game = {}));
var ut;
(function (ut) {
